...
import com.example.dacs3.activity.detaildiadiem;
...
public class DiadiemAdapter extends FirebaseRecyclerAdapter<Amthuc, DiadiemAdapter.ddHolder> {
    public DiadiemAdapter(@NonNull FirebaseRecyclerOptions<Amthuc> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull DiadiemAdapter.ddHolder ddHolder, int position, @NonNull Amthuc amthuc) {
        ddHolder.title.setText(amthuc.getTitle());
        ddHolder.location.setText(amthuc.getLocation());
        float score = (float) amthuc.getScore();
        DecimalFormat df = new DecimalFormat("#.#");
        String formattedScore = df.format(score);
        ddHolder.score.setText(formattedScore);
        Glide.with(ddHolder.pic.getContext())
                .load(amthuc.getPic())
        ...
        ddHolder.btn_update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogPlus dialogPlus = DialogPlus.newDialog(ddHolder.title.getContext())
                ...
                btn_update_dialog.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Diadiem")
                                .child(getRef(ddHolder.getAdapterPosition()).getKey())
                                .updateChildren(map)
        ...
        ddHolder.btn_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ddHolder.title.getContext());
                ...
                builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(ddHolder.title.getContext(), "Cancelled", Toast.LENGTH_SHORT).show();
                    }
                });
                builder.show();
            }
        ...
        ddHolder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {


                Intent intCard = new Intent(ddHolder.title.getContext(), detaildiadiem.class );
                ...
                ddHolder.title.getContext().startActivity(intCard);
            }
        });
    }
    ...
    @NonNull
    @Override
    public DiadiemAdapter.ddHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_item,parent,false);

        return new DiadiemAdapter.ddHolder(view);
    }
    ...
    class ddHolder extends RecyclerView.ViewHolder{
        ...
        public ddHolder(@NonNull View itemView) {
            super(itemView);
